...
<html lang="en">
     <head>
        ...
        <!-- Favicon -->
        <link rel="icon" type="image/png" sizes="56x56" href="{{ asset('login/') }}/images/fav-icon/icon.png">
        <!-- Bootstrap  -->
            ...
            <div class="container">
                <div class="login-form">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <div class="img-box">
                                <img src="{{ asset('login/') }}/images/login-img.png" class="back-img" title="login" alt="welcome image">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="login-box">
    ...
    @csrf
                                    ...
                                    <div class="input-group check-field">
                                        <div>
                                            ...
                                            <label for="test"> Remember Me</label><br>
                                        </div>
                                        <a href="#" class="forgot">Forgot password?</a>
                                    </div>
                                    <div class="form-group text-center">
                                        <button type="submit" class="btn btn-primary">Login</button>
                                        <p class="mb-0"> <a href="#">New User? Sign Up</a></p>
                                    </div>
                                </form>
                            </div>
                        </div>
